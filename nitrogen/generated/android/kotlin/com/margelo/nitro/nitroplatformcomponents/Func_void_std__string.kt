...
/**
 * Represents the JavaScript callback `(actionKey: string) => void`.
...
fun interface Func_void_std__string: (String) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(actionKey: String): Unit
}
...
class Func_void_std__string_cxx: Func_void_std__string {
  ...
  @Keep
  override fun invoke(actionKey: String): Unit
    = invoke_cxx(actionKey)

  @FastNative
  private external fun invoke_cxx(actionKey: String): Unit
}
...
class Func_void_std__string_java(private val function: (String) -> Unit): Func_void_std__string {
  ...
  @Keep
  override fun invoke(actionKey: String): Unit {
    return this.function(actionKey)
  }
}
