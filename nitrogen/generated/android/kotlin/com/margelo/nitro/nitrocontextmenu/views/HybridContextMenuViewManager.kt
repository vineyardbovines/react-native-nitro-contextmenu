///
/// HybridContextMenuViewManager.kt
 ...
 */
public class HybridContextMenuViewManager: SimpleViewManager<View>() {
  init {
    if (RecyclableView::class.java.isAssignableFrom(HybridContextMenuView::class.java)) {
  ...
  private fun getHybridView(view: View): HybridContextMenuView? {
    return view.getTag(associated_hybrid_view_tag) as? HybridContextMenuView
  }
}
