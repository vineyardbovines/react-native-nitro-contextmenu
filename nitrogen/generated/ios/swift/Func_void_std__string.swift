...
/**
 * Wraps a Swift `(_ actionKey: String) -> Void` as a class.
...
public final class Func_void_std__string {
  ...
  private let closure: (_ actionKey: String) -> Void

  public init(_ closure: @escaping (_ actionKey: String) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(actionKey: std.string) -> Void {
    self.closure(String(actionKey))
  }
